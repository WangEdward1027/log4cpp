...
int main()
{
    ...
    PatternLayout * ptn5 = new PatternLayout();
    ptn5->setConversionPattern("%d %c [%p] %m%n");
    ...
    while(count > 0){
        ...
        cat.fatal("this is a fatal msg");
        cat.alert("this is an alert msg");
        cat.crit("this is a crit msg");
        cat.error("this is an error msg");
        cat.warn("this is a warn msg");
        cat.notice("this is a notice msg");
        cat.info("this is an info msg");
        cat.debug("this is a debug msg");
        --count;
    }
